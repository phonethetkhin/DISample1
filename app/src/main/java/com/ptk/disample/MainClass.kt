...
fun main() {
    ...
    val information = Information(hobbies, skills, accomplishments)
    ...
    val employee = Employee("E001", "Thomas", education, experience, resume, information)
    val company = Company("Com1", employee)

    company.showEmployeeName()
}